...
df_cus = spark.read.parquet('hdfs://ip-172-31-3-251.eu-west-2.compute.internal:8020/tmp/rutvik_proj/bronze/shopee_cus')
df_ord_itm = spark.read.parquet('hdfs://ip-172-31-3-251.eu-west-2.compute.internal:8020/tmp/rutvik_proj/bronze/shopee_ord_itm')
df_prd=spark.read.parquet('hdfs://ip-172-31-3-251.eu-west-2.compute.internal:8020/tmp/rutvik_proj/bronze/shopee_prd')
df_seller=spark.read.parquet('hdfs://ip-172-31-3-251.eu-west-2.compute.internal:8020/tmp/rutvik_proj/bronze/shopee_seller')
...
df_cus.write.mode("overwrite").parquet("hdfs://ip-172-31-3-251.eu-west-2.compute.internal:8020/tmp/rutvik_proj/silver/shopee_cus")
df_ord_itm.write.mode("overwrite").parquet("hdfs://ip-172-31-3-251.eu-west-2.compute.internal:8020/tmp/rutvik_proj/silver/shopee_ord_itm")
df_seller.write.mode("overwrite").parquet("hdfs://ip-172-31-3-251.eu-west-2.compute.internal:8020/tmp/rutvik_proj/silver/shopee_seller")
df_prd.write.mode("overwrite").parquet("hdfs://ip-172-31-3-251.eu-west-2.compute.internal:8020/tmp/rutvik_proj/silver/shopee_prd")
