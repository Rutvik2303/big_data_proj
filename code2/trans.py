...
df_cus = spark.read.parquet('hdfs://ip-172-31-3-251.eu-west-2.compute.internal:8020/tmp/rutvik_proj/silver/shopee_cus')
df_ord_itm = spark.read.parquet('hdfs://ip-172-31-3-251.eu-west-2.compute.internal:8020/tmp/rutvik_proj/silver/shopee_ord_itm')
df_prd=spark.read.parquet('hdfs://ip-172-31-3-251.eu-west-2.compute.internal:8020/tmp/rutvik_proj/silver/shopee_prd')
df_seller=spark.read.parquet('hdfs://ip-172-31-3-251.eu-west-2.compute.internal:8020/tmp/rutvik_proj/silver/shopee_seller')
...
#spark.sql("CREATE DATABASE IF NOT EXISTS rutvikdb")
#df_higest_sales_day.write.mode("overwrite").saveAsTable("sale_per_day")
#spark.catalog.setCurrentDatabase("rutvikdb")

df_total_com_prd.write.mode("overwrite")\
    .option("path", "hdfs://ip-172-31-3-251.eu-west-2.compute.internal:8020/warehouse/tablespace/external/hive/rutvikdb.db/com_prd") \
    .saveAsTable("rutvikdb.com_prd")
spark.sql("SHOW DATABASES").show()
spark.sql("SELECT * FROM rutvikdb.com_prd LIMIT 10").show()
