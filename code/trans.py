...
df_higest_sales_day.write.mode("overwrite").saveAsTable("rutvikdb.sale_per_day1")
df_total_com_prd.write.mode("overwrite").saveAsTable("rutvikdb.com_prd1")
df_total_ord_city.write.mode("overwrite").saveAsTable("rutvikdb.ord_city1")
df_cus_return.write.mode("overwrite").saveAsTable("rutvikdb.prd_return1")
df_worst_seller.write.mode("overwrite").saveAsTable("rutvikdb.worst_seller1")
